...
const parse = require('react-docgen').parse; //look at the components and look the metadata from components code
const chokidar = require('chokidar'); //allows to watch files and run a function
...
//Map over directories to get component data
